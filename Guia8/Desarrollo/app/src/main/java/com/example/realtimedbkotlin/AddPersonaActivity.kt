...
import com.example.realtimedbkotlin.PersonasActivity.Companion.database
...
class AddPersonaActivity : AppCompatActivity() {
    ...
    private fun inicializar(){
        ...
        //Obtencion de datos que envia actividad anterior
    ...
    fun guardar(v: View?){
        ...
        if(accion == "a"){//Agregar registro
            ...
            Toast.makeText(this, "Se ha actualizo con exito", Toast.LENGTH_SHORT).show()
        }
        finish()
    }
